...
?>
<div class="container">
<h1 class = "mt-5 mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-newspaper" viewBox="0 0 16 16">
  <path d="M0 2.5A1.5 1.5 0 0 1 1.5 1h11A1.5 1.5 0 0 1 14 2.5v10.528c0 .3-.05.654-.238.972h.738a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 1 1 0v9a1.5 1.5 0 0 1-1.5 1.5H1.497A1.497 1.497 0 0 1 0 13.5v-11zM12 14c.37 0 .654-.211.853-.441.092-.106.147-.279.147-.531V2.5a.5.5 0 0 0-.5-.5h-11a.5.5 0 0 0-.5.5v11c0 .278.223.5.497.5H12z"/>
  <path d="M2 3h10v2H2V3zm0 3h4v3H2V6zm0 4h4v1H2v-1zm0 2h4v1H2v-1zm5-6h2v1H7V6zm3 0h2v1h-2V6zM7 8h2v1H7V8zm3 0h2v1h-2V8zm-3 2h2v1H7v-1zm3 0h2v1h-2v-1zm-3 2h2v1H7v-1zm3 0h2v1h-2v-1z"/>
</svg> Галерея</h1>
   
<div class="gallery mb-5" style="margin-top:0px!important;">

<div class="gallery-item">
    <div class="gallery-text">
        <p>Диплом №1</p>
        <div class="gallery-admin">
            <img src="App/images/news1.jpg" class="gallery-admin" alt="gallery">
            
        </div>
        <div class="crud">
              <a href="" style="color:red; margin:10px; text-decoration:none;">Удалить</a>
            </div>
    </div>
</div>
...
<br>
<h1 class="mt-5"><svg xmlns="http://www.w3.org/2000/svg" width="31" height="31" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
  <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
  <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
</svg> Добавить Фото в Галерею</h1>
<form action="/addgallery" method="POST" enctype="multipart/form-data">


<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Название</label>
  <input name="title" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Новое фото">
</div>
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">Категория</label>
  <select name="category" class="form-select" aria-label="Default select example">
  <option selected>Выберите категорию</option>
  <option value="1">Дипломы</option>
